...
mortality<-read.csv("/IHME-GBD_2019_DATA-Global_death.csv",as.is=T)
...
Pop<-read.csv("/Pop_2023_NA_Grid_byAge.csv")
...
write.csv(avg,"/GBD_longterm_deaths_NA_national_GFED.csv",row.names=F)